...
public class ThirdActivity extends AppCompatActivity {
    ...
    Double recommendPostN, recommendPostP,  recommendPostK;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            adapterC = new ArrayAdapter<String>(ThirdActivity.this, android.R.layout.simple_spinner_dropdown_item, categoryData);
            ...
            spCategory.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    adapterN = new ArrayAdapter<String>(ThirdActivity.this, android.R.layout.simple_spinner_dropdown_item,nameData);
            ...
            spName.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                ...
                public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    string1 = cursor2.getString(11); // 추천 웃거름1
                    string2 = cursor2.getString(12); // 추천 웃거름2
                    string3 = cursor2.getString(13); // 추천 웃거름3
        ...
        btnCal.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(getApplicationContext(), ThirdCalResultActivity.class);
